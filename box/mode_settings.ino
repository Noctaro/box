...
void Modeswitch()
{
//Den gewÃ¼nschten Modus im Code manuell setzen 0/1/2 - HierfÃ¼r muss die nÃ¤chste Zeile auskommentiert werden  
Mode = 1;                               

//Lese den Status des physichen Modeschalters fÃ¼r die Wahl des gewÃ¼nschten Modus - HiefÃ¼r muss die vorherige Zeile auskommentiert werden
//Mode = digitalRead(Modeschalter);     
}
//*********************************************************************************************************
...
//**************************************************
  ...
  //Dauer der BelÃ¼ftung in Sekunden (muss mehr als 60 Sekunden sein)
  air_refresh_secound = 120; 
  
  //Minute zu der die BelÃ¼ftung eingeschaltet wird, sofern es die Luftfeuchtigkeit erlaubt.
...
*/
  ...
  */
    ...
    //*********************************************************************************************************
   //GUI SETTINGS
  //Wenn Telemetriedaten via serial gesendet wurden, diese verwenden
 //********************************************************************************************************* 
  if (gui_opt_temp > 0)
    {
